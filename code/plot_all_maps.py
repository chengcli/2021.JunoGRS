...
from colormaps import import_ncl_cmap, shift_colormap
import glob
...
def plot_map_pair(ax1, ax2, lats, pres, nh3s, tps):
  ...
  ax1.plot([-24, -24], [100., 0.3], 'C4', linewidth = 1)
  ax1.plot([-16, -16], [100., 0.3], 'C4', linewidth = 1)
  ax1.plot([-20, -20], [100., 0.3], 'C4--', linewidth = 1)
  ax1.set_yscale('log')
...
if __name__ == '__main__':
  # baseline ammonia
  hdul = fits.open('../PJ1345689V3/profile_PJ1345689_2.7x20.x168.fits')
